...
public class SendHTMLEmail {
	...
	public String textoEmail(String usuario, String senha) {
		StringBuilder builder = new StringBuilder();
		builder.append("Bem vindo! Obrigado por se cadastrar. \n\n");
		builder.append("Credenciais \n\n");
	...
	/*public static void main(String[] args) {
		...
		email.enviarEmail("tony", "1");
	} */

	public void enviarEmail(String login, String senha) {
		...
		EmailUtil.sendEmail(session, toEmail, "PR�-CADASTRO SPORTSGO", textoEmail(login, senha));
	}
