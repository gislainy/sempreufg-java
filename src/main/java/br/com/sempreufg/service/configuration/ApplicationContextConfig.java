...
@Configuration
@ComponentScan(basePackages="br.com.sempreufg")
...
public class ApplicationContextConfig {	
    ...
    public DataSource getDataSource() {
    	...
    	dataSource.setUrl("jdbc:postgresql://localhost:5432/sempreufg");
	...
	private Class[] getClassesAnotadas() {
		...
		for (BeanDefinition bd : scanner.findCandidateComponents("br.com.sempreufg")) {
