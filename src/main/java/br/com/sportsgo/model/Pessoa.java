...
public class Pessoa{
    ...
    //private String cpfCnpj; OBS: Para validar Ã© necessÃ¡rio separar os 2 atributos. (CPF 11 Digitos, CPNJ 14 DÃ­gitos)
    private String cpf;
    private String cnpj;
    ...
    public boolean ValidarCnpj(String cnpj){
    	cnpj = cnpj.replaceAll("\\.", "").replaceAll("-","").replaceAll("/", ""); //Remove pontos e o traço, caso existam
